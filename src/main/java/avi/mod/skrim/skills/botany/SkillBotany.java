...
public class SkillBotany extends Skill implements ISkillBotany {
	...
	public static SkillAbility SUN_FLOWER = new SkillAbility("botany", "Sun Flower", 25, "It was either this or mariglow, don't know which one is worse.",
			"Enables you to craft glowing flowers with a flower & glowstone dust.");
	public static SkillAbility THORN_STYLE = new SkillAbility("botany", "Thorn Style", 50, "I'll let you try my thorn style.",
			"While holding a flower return §a25%" + SkillAbility.descColor + " of melee damage.");
	public static SkillAbility SEDUCE_VILLAGER = new SkillAbility("botany", "Seduce Villager", 75, "[Tongue waggling intensifies]",
			"Using a flower on a villager consumes it and reduces the cost of all trades by §a1" + SkillAbility.descColor + ".");
	public static SkillAbility ENCHANTED_FLOWER = new SkillAbility("botany", "Enchanted Flower", 100, "It shares a giant friendliness beam! :D",
