  ...
  protected void onHit(RayTraceResult raytraceResultIn) {
    ...
    if (this.explosionType != null) {
      if (this.explosionType.equals("normal_tnt")) {
        ...
        CustomExplosion explosion = CustomTNTPrimed.createExplosion(this.explosionType, null, this.world, this.shootingEntity, pos.getX()
            , pos.getY(), pos.getZ());
        if (this.shootingEntity.hasCapability(Skills.DEMOLITION, EnumFacing.NORTH)) {
          ...
          explosion.setExplosionSize((float) (explosion.getExplosionSize() * (1 + demolition.getExtraPower())));
