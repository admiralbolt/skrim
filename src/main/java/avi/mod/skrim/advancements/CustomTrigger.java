 ...
 * Thanks jabelar!
 * <p>
 * Minecraft has a pretty good advancement / triggers system, but it doesn't cover everything. This is a way of
 * registering a custom trigger that can be activated at any time by sending an AdvancementPacket(). That way
 * advancements can be triggered anytime in code.
 * <p>
 * <p>
...
public class CustomTrigger implements ICriterionTrigger<CustomTrigger.Instance> {
  ...
  /* (non-Javadoc)
   * @see net.minecraft.advancements.ICriterionTrigger#addListener(net.minecraft.advancements.PlayerAdvancements, net
   * .minecraft.advancements.ICriterionTrigger.Listener)
   */
  @Override
  public void addListener(PlayerAdvancements playerAdvancementsIn,
                          ICriterionTrigger.Listener<CustomTrigger.Instance> listener) {
