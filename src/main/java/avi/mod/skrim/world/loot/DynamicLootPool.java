...
public class DynamicLootPool {
  ...
  public static LootPool ARTIFACT_POOL = new DynamicLootPool("artifact_pool", 40000, 35, 30, 2, 0, SkrimItems.RAFFLE_TICKET,
  ...
  public static LootPool HIGH_CHANCE_ARTIFACT_POOL = new DynamicLootPool("high_chance_artifact_pool", 5000, 35, 30, 2, 0, SkrimItems.RAFFLE_TICKET,
      Stream.concat(Arrays.stream(SkrimItems.ARTIFACTS), SkrimBlocks.RegistrationHandler.ARTIFACT_ITEM_BLOCK_MAP.values().stream())).toLootPool();
