...
public class WorldGenWeirwood extends WorldGenerator {
  ...
  private List<BlockPos> getLeafPositions(World worldIn, Random rand, BlockPos position, int trunkY) {
  ...
  private List<BlockPos> getLeafCross(BlockPos position, int radius, int height) {
    List<BlockPos> crossPositions = new ArrayList<>();
