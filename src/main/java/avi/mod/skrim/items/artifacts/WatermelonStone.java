...
public class WatermelonStone extends ArtifactItem {

  public WatermelonStone() {
    super("watermelon_stone");
    this.setMaxDamage(1);
  }

  @Override
  public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
    tooltip.add("§4Used for making Watermoolons!§r");
    tooltip.add("§e\"What? Cow is evolving!\"§r");
  }

  @Mod.EventBusSubscriber(modid = Skrim.MOD_ID)
  public static class WatermelonStoneHandler {

    @SubscribeEvent
    public static void evolveCow(PlayerInteractEvent.EntityInteract event) {
      if (event.getItemStack().getItem() != SkrimItems.WATERMELON_STONE) return;
      ...
      EntityCow entitycow = new EntityWatermoolon(cow.world);
