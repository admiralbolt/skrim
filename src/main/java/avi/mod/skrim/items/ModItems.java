...
public class ModItems {
	...
	public static ArmorMaterial OBSIDIAN_ARMOR = EnumHelper.addArmorMaterial("obsidian", "skrim:obsidian_armor", 40, new int[] { 4, 9, 7, 4 }, 20, null, 1.0F);
	...
	public static ArtifactArmor CERULEAN_SANDALS;
	...
	public static void registerArtifacts() {
		...
		CERULEAN_SANDALS = register(new CeruleanSandals());
		ARTIFACTS.add(CERULEAN_SANDALS);
