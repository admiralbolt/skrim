...
/**
 * Copy of TileEntityBeaconRenderer.java.
 */
...
public class TileEntityEnchantedFlowerRenderer extends TileEntitySpecialRenderer<EnchantedFlowerTileEntity> {
  ...
  public void render(EnchantedFlowerTileEntity te, double x, double y, double z, float partialTicks, int destroyStage
			, float alpha) {
    this.renderBeacon(x, y + 1, z, (double) partialTicks, (double) te.shouldBeamRender(), te.getBeamSegments(),
  ...
  public void renderBeacon(double x, double y, double z, double partialTicks, double textureScale,
    ...
    if (textureScale > 0.0D) {
      ...
      for (int j = 0; j < beamSegments.size(); ++j) {
        ...
        renderBeamSegment(x, y, z, partialTicks, textureScale, totalWorldTime, i,
